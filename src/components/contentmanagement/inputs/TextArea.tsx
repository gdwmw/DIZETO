...
export default function TextArea({ width, id, label, value, onChange }: TextAreaProps) {
  return (
    <fieldset
    ...
    >
      ...
      <textarea id={id} value={value} onChange={onChange} className="w-full rounded-md bg-transparent px-2 outline-none dark:text-white" />
    </fieldset>
  );
}
