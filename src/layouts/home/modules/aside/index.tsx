...
export const ASide: FC = (): ReactElement => {
  ...
  return (
    <aside
      className={`fixed inset-y-0 right-0 z-[2] w-full max-w-[250px] bg-white/50 p-5 shadow-black/50 backdrop-blur-md transition-all dark:bg-black/50 dark:shadow-white/50 ${openASide ? "translate-x-0 shadow-md" : "translate-x-full shadow-none"}`}
    >
