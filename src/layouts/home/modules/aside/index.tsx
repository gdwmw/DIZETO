...
import { handleSmoothScroll, LINKS_DATA } from "../header/batches";
...
export const ASide: FC = (): ReactElement => {
  ...
  return (
    <aside
      className={`fixed right-0 top-0 z-[7] h-dvh w-full max-w-[250px] bg-white/50 p-5 shadow-black/50 backdrop-blur-md transition-all dark:bg-black/50 dark:shadow-white/50 ${openASide ? "translate-x-0 shadow-md" : "translate-x-full shadow-none"}`}
    >
